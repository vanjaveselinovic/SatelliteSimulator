...
public class RingData {
	int ringNumber;//rings are counted from 1, no 2 rings have the same number
	int[] stationIds;//the ids of all the stations in this ring
    ...
    double semimajorAxis;				//{in m from Earth's core}the mean radius. You can treat this like the radius.
