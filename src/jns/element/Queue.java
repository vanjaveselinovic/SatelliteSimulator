...
public abstract class Queue extends Element {
	 ...
	 * 
	 * @param length
	 *            maximum length of the queue in bytes, 0 if the queue is infinite
	 */
	...
	/**
	 * Return the maximum length of the queue in bytes. Returns 0 for an infinite
	 * queue.
	 * 
	...
	/**
	 * Enqueue a packet in this queue, if it fits in. The routine fails silently if
	 * the packet does not fit it. If you have to know in advance if it will, use
	 * the isFull function first.
	 * 
	 * @param packet
	...
	/**
	 * Dequeue a packet from this queue. Note that this does not mean the packet at
	 * the end of the queue is being dequeued. The queueing policy is decided by
	 * subclasses.
	 * 
