...
public class QueueDropTail extends Queue {
	 ...
	 * whole, it will not be enqueued. If the packet does fit in, but there is not
	 * enough space, packets will be dropped at the end of the queue before
	...
	/**
	 * A private helper function that will drop the packet at the end of the queue
	 * and generate a drop event.
	 */
	private void drop() {
	...
	/**
	 * Dequeue a packet from this queue. The queue policy is that the packet at the
	 * end of the queue will be returned. In addition, a dequeue event will be
	 * generated.
	 * 
	...
	/**
	 * Do nothing. In a more sophisticated queue we could schedule clean-up runs to
	 * take place in here...
	 */
	public void update() {
	}
