...
public class EventGenerator {
	...
	/**
	 * makePacketEvent will create a packet event of type 'name', where name is
	 * HopEvent, ReceiveEvent, etc. from the IP packet that is passed.
	 * 
	 * @param name
	 *            the event name of the packet event to be generated, e.g.
	 *            "HopEvent"
	 * @param packet
	 *            the IP packet from which to take event information
	...
	public static Event makePacketEvent(String name, IPPacket packet) {
		...
		event.addParameter("Packet Protocol", new Integer(packet.protocol));
