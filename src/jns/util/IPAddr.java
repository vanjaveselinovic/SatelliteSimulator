...
public class IPAddr {
	...
	/**
	 * Create an IP address from the four byte parameters. They are integers but
	 * should be in range 0-255, otherwise they will be clipped. The address
	 * provided as (a1,a2,a3,a4) will be turned into an IP address of the form
	 * a1.a2.a3.a4.
	 */
	...
	/**
	 * Create a new IP address by taking a previously created raw IP address.
	 */
	...
	public String toString() {
		return ((m_addr >> 24) & 0xff) + "." + ((m_addr >> 16) & 0xff) + "." + ((m_addr >> 8) & 0xff) + "."
				+ (m_addr & 0xff);
	}
