...
public interface DynamicScheduler extends Remote {
	public void scheduleUnicast(InetAddress senderIPAddr, InetAddress receiverIPAddr, byte[] data)
			throws RemoteException;

	public void scheduleMulticast(InetAddress senderIPAddr, InetAddress multicastGroup, byte[] data)
			throws RemoteException;
