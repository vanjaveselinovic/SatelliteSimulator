...
/**
 * Very simple generice jns.command.Command that will send an UDP/IP packet from
 * the node who's IPHandler gets passed in, to the receiverIPAddress node. The
 * data in the packet is the data parameter to the constructor.
 */
